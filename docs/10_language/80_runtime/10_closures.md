...
- Binds each name to a **reactive identity** (see [Reactivity Model](../20_data_model/03_reactivity.md))
...
the [Reactivity Model](../20_data_model/02_type_system.md) documentation.
